...
export default function Contact() {
    ...
    return (
        <section id="contact" className="relative bg-[var(--accent)] text-black overflow-hidden">
            ...
            <div className="absolute -top-1/2 -right-1/4 w-[60vmin] h-[60vmin] border border-black/5 rounded-full" />
            <div className="absolute -bottom-1/2 -left-1/4 w-[50vmin] h-[50vmin] border border-black/5 rounded-full" />
            ...
            <div className="max-w-7xl mx-auto relative" ref={ref}>
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <p className="text-[clamp(1.125rem,1.5vw,1.25rem)] text-black/70 mt-8 max-w-[min(400px,90vw)]">
                            ...
                            {socials.map((social, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-black/60 text-sm">@Deepanshu-Sharma</p>
                                    </div>
